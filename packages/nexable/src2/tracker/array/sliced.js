function SlicedArray(base, start, end) {
    var self = this;
    self._items = [];
    self._base = base;
    ...
    self._start = computed(function () { return toInteger(start, 0); });
    self._end = computed(function () { return toInteger(end, Infinity); });
...
SlicedArray.prototype = rawObject({
